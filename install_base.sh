...
rpm -ivh \
 ...
 /usr/src/rpm/RPMS/$ARCH/glibc-2.10.1-2.$ARCH.rpm \
 /usr/src/rpm/RPMS/$ARCH/readline-6.0-1.$ARCH.rpm \
 /usr/src/rpm/RPMS/$ARCH/bash-4.0-2.$ARCH.rpm \
 /usr/src/rpm/RPMS/$ARCH/bash-doc-4.0-2.$ARCH.rpm \
 ...
 /usr/src/rpm/RPMS/$ARCH/coreutils-7.6-1.$ARCH.rpm  \
 ...
 /usr/src/rpm/RPMS/$ARCH/gzip-1.3.13-1.$ARCH.rpm  \
